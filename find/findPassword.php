...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT youPass, youName FROM myMembers WHERE youId = '$youId' AND youPhone = '$youPhone'";
...
?>
            ...
            <?php if (isset($maskedPassword)) { ?>
                ...
                <h2>비밀번호 찾기 완료</h2>
                <p>😎 <em><?php echo $youName; ?></em> 님의 비밀번호는 <em style="color: #1976DE;"><?php echo $maskedPassword; ?></em> 입니다.</p>
                <div class="join__form">
                    <form action="#" name="#" method="post">
