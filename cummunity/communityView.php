    ...
    <main id="main">
        <div class="container view_inner">
            <div class="article">
                ...
                <div class="name"><?=$blogInfo['blogAuthor']?></div>
                <div class="hinfo">
                    <span class="dat"><img src="../assets/img/clock.svg" alt="Clock Icon"> <?=date('Y-m-d', $blogInfo['blogRegTime'])?></span>
                    <span class="pv"><img src="../assets/img/read1.svg" alt="Clock Icon"> <?=$blogInfo['blogView']?></span>
                    <span class="cmt"><img src="../assets/img/thumbs.svg" alt="Clock Icon"> <?=$blogInfo['blogLike']?></span>
                </div>
            </div>
            ...
            <div class="comment_btn">
                <div class="cinfo" data-blogid="<?= $blogId ?>" <?= in_array($blogInfo['blogId'], array_column($blogLikesInfo, 'blogId')) ? 'data-loggedinuser="true"' : ''; ?>>
                    <span id="likeButton" class="like" data-blogid="<?= $blogId ?>">
                        ...
                        <em>좋아요</em>
                        <span id="likeCount" class="likeCount" data-blogid="<?= $blogId ?>"><?= $blogInfo['blogLike'] ?></span>
                    </span> 
                    <!-- 좋아요 수를 표시할 부분 -->
                </div>
...
<?php
    ...
    <?php } else {
        ...
        foreach ($commentResult as $comment) {
            ...
            ?>
<div class="comment-container" data-commentid="<?= $comment['commentId'] ?>" <?= in_array($comment['commentId'], array_column($commentLikesInfo, 'commentId')) ? 'data-loggedinuser="true"' : ''; ?>>
