            ...
            <div class="board__form">
                <form action="boardWriteSave.php" name="boardWriteSave.php" method="post" enctype="multipart/form-data">
                    <div>
                        ...
                        <input type="text" id="blogTitle" name="blogTitle" class="input__style" placeholder="제목을 입력해주세요.">
                    </div>
                    <div>
                        <label for="blogContents"></label>
                        <textarea name="blogContents" id="blogContents" rows="20" class="input__style"  placeholder="내용을 입력해주세요."></textarea>
                    </div>
                    <div class="file">
