<?php
    ...
    $sql = "INSERT INTO myMembers(youId, youName, youEmail, youPass, youAddress, youPhone, youRegTime) VALUES('$youId', '$youName', '$youEmail', '$youPass', '$youAddress', '$youPhone', '$youRegTime')";
    $connect -> query($sql);
